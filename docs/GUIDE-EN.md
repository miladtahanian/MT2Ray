...
**MT2Ray** is an enterprise-grade wrapper around the `g2ray` project. It leverages **GitHub Codespaces** (free cloud development environments) to run a **VLESS proxy** on GitHub's global infrastructure.
...
1. Navigate to: `https://github.com/miladtahanian/MT2Ray`
...
git clone https://github.com/miladtahanian/MT2Ray.git
cd MT2Ray

# Build the Docker image
docker build -t MT2Ray .devcontainer/

# Run the container
docker run -p 443:443 -p 8080:8080 MT2Ray
...
<p align="center"> <b>© 2026 MT2Ray | Licensed under MIT</b><br> <sub>Empowering free internet access worldwide</sub> </p> ```
